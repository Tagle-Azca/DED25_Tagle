...
/* =============================================================
  ...
  1: Describe in your own words, what a pointer is.
    R: a poniter is when you want something to be redirecting at the variable, but you dont want to put the variable per se, you use a pointer or a redirection
     to lead you to that varibale and then you can use ir
  ...
  4: What is a void * used for?
    R: a void pointer is a pointer to any type

  5: What do I need to do before dereferencing or
     try to use a void pointer?
    R: you need to cast it to the type what you want
*/
